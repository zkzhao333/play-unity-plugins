...
public class PurchaseController : MonoBehaviour, IStoreListener
{
    ...
    private static void ExecutePurchase(string productId)
    {
        ...
        foreach (var coin in CoinList.List)
        {
            if (!String.Equals(productId, coin.ProductId, StringComparison.Ordinal))
            {
                continue;
            }
        ...
        {
            if (!String.Equals(productId, car.ProductId,
        ...
        {
            if (!String.Equals(productId, subscription.ProductId,
                StringComparison.Ordinal))
            {
                continue;
            }
